...
footer.innerHTML = `
  <div class="footer-container">
    ...
    <div class="footer-logo">
        ...
        <ul class="footer-logo footer-logo-social">
          <li>
            <a
          ...
          <li>
            <a
              ...
              class="logo logo-circle"
              aria-label="visit our github account"
              target="_blank"
            >
    ...
    <div class="footer-bottom"> 
       ...
       <ul class="footer-payments">
        <li class="payment-image"><img src="${visa}" alt="visa"></li>
        <li class="payment-image"><img src="${master}" alt="master-card"></li>
        <li class="payment-image"><img src="${paypal}" alt="paypal"></li>
        <li class="payment-image"><img src="${apple}" alt="apple-pay"></li>
        <li class="payment-image"><img src="${google}" alt="google-pay"></li>
      </ul>
   </div>
  </div>
`
